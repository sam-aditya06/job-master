      ...
      <div className="relative flex flex-col justify-center items-center gap-10 mx-auto mt-[3.5rem] max-w-7xl h-full z-20">
        <div className="w-fit lg:w-[41rem] px-2">
          <h1 className="text-4xl md:text-7xl text-center font-bold leading-tight tracking-tight mb-4"
            ...
            Your Roadmap to a{" "}
            <span className="text-brand">Government Career</span>
          </h1>
          <p className="text-lg text-white/60 text-center font-light">
            From exam notifications to salary breakdowns — everything you need to crack govt jobs in India.
          </p>
        </div>
        <Link className="rounded-sm bg-brand px-3 py-2" href='/recruitments'>Explore Recruitments</Link>
